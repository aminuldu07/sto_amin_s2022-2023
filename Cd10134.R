...
df1 <- read.csv("nc216.csv")
df2 <- read.csv("abw883.csv")
...
print(zscore_df)
Zscores <- zscore_df %>% select(STUDYID, USUBJID, EXROUTE, SEX, BWTESTCD, zscore)
write.csv(Zscores, "Zscores.csv", row.names = FALSE)

#.................................................................................................
df3 <- read.csv("Zscores.csv")
uniqueZscore <- unique (df3)
uniqueZscore
my_unique_data <- distinct(df3, Zscores, .keep_all = TRUE)
my_unique_data
